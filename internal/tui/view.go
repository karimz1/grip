...
func (a *App) footer() []string {
	...
	case detailScreen:
		...
		if a.width < 80 {
			return shortcutLines(w, shortcut{"/", "search"}, lockHint, shortcut{"↑↓", "select"}, shortcut{"←→", "path"}, shortcut{"Esc", "back"})
		}
		return shortcutLines(w, shortcut{"/", "search"}, lockHint, shortcut{"↑↓", "select"}, shortcut{"←→", "path"}, shortcut{"k", "stop"}, shortcut{"x", "force kill"}, shortcut{"Esc", "back"})
	case helpScreen:
